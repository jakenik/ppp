//获取元素节点
var jsDiv = $("#playground");
var jsSnack = $("#snack");
var jsFood = $("#food");
var jsBody = $("#playground");
var jsScore = $("#score");
//设置全局变量
...
document.onkeydown = function(e) {
 ...
 //食物随机出现
function Pos(){
    jsFood.css({"left":parseInt(Math.random() * (430 - 20 + 1) + 20) + "px"})
    jsFood.css({"top":parseInt(Math.random() * (380 - 20 + 1) + 20) + "px"})
}
Pos();
...
function eat(){
 ...
 function follow(){
  ...
  for( var i = 0 ; i<bodyNum.length ; i++){
    ...
    bodyNum[i].css({"left":srr[num-place][0] + 'px'})
    bodyNum[i].css({"top":srr[num-place][1] + 'px'})    
  }
}
